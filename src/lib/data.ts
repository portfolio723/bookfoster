...
export const books: Book[] = [
  {
    ...
    price: 499,
    rent: 99,
    donor: { id: 'user1', name: 'Priya Sharma', avatarImageId: 'donor1' },
    imageIds: ['book1'],
  },
  {
    id: '2',
    ...
    price: 349,
    rent: 79,
    donor: { id: 'user2', name: 'Arjun Verma', avatarImageId: 'donor2' },
    imageIds: ['book2'],
  },
  {
    id: '3',
    ...
    price: 599,
    rent: 129,
    donor: { id: 'user3', name: 'Ananya Reddy', avatarImageId: 'donor3' },
    imageIds: ['book3'],
  },
  {
    id: '4',
