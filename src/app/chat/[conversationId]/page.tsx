  ...
  return (
    <div className="flex flex-col h-screen bg-muted/20">
      <header className="flex items-center gap-4 border-b bg-background px-4 lg:px-6 h-16 shrink-0">
        <Link href="/chat" className="lg:hidden -ml-2">
        ...
        <div className="flex items-center gap-3">
            <Avatar className="h-10 w-10">
              <AvatarImage src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxJbmRpYW4lMjBwZXJzb24lMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjQ4NzAyMjd8MA&ixlib=rb-4.1.0&q=80&w=1080" data-ai-hint="Indian person" className="object-cover" />
      ...
      <div className="border-b bg-background p-3 shadow-sm">
