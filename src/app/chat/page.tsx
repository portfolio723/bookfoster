...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] bg-muted/20">
      <header className="flex items-center gap-4 border-b bg-background px-4 lg:px-6 h-16 shrink-0 sticky top-16 md:top-0 z-10">
       ...
       <div className="border-b bg-background p-3 sticky top-[128px] md:top-16 z-10 shadow-sm">
